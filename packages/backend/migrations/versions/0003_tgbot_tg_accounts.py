...
Revision ID: 0003
Revises: 0002
Create Date: 2025-05-03 15:45:19.333007
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id", name=op.f("pk_tgbot_tg_accounts")),
    )
    op.create_index(
        op.f("ix_tgbot_tg_accounts_api_id"),
        "tgbot_tg_accounts",
        ["api_id"],
        unique=True,
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f("ix_tgbot_tg_accounts_api_id"), table_name="tgbot_tg_accounts")
    op.drop_table("tgbot_tg_accounts")
    sa.Enum(
        "initial", "sent_code", "active", "disabled", name="tgbot_tg_account_status"
